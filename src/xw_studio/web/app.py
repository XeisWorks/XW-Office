...
from xw_studio import __version__
from xw_studio.content import BrandProfile, BrandProfileCatalog
...
<body>
  <main>
    ...
    <p>Die gemeinsame Weboberfläche für Content-Anlässe, Entwürfe und spätere Freigaben wird
       schrittweise aufgebaut. Operative Rechnungs- und Druckabläufe bleiben in XW-Studio Desktop.</p>
    <section class=\"card\">
