...
from xw_studio.services.crm.preflight import MergePreflightReport, build_preflight_report
...
class CrmService:
    ...
    def preflight_merge(self, duplicate: ContactRecord) -> MergePreflightReport:
        ...
        established in ``xw_studio.services.xw_copilot`` for any operation
