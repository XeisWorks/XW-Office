...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self._status_bar = OfficeStatusBar()
        self.setStatusBar(self._status_bar)
        self._status_bar.showMessage("Bereit", 5000)

        from xw_office.ui.home_view import HomeView
    ...
    def _build_gutscheine_page(self) -> QWidget:
        from xw_office.ui.modules.gutscheine.view import GutscheineView

        return GutscheineView(self._container)

    def _build_mollie_page(self) -> QWidget:
        from xw_office.ui.modules.mollie.view import MollieView
    ...
    def _build_crm_page(self) -> QWidget:
        from xw_office.ui.modules.crm.view import CrmView
    ...
    def _build_statistics_page(self) -> QWidget:
        from xw_office.ui.modules.statistics.view import StatisticsView
    ...
    def _build_wuedaramusi_page(self) -> QWidget:
        from xw_office.ui.modules.wuedaramusi.view import WuedaraMusiView

        return WuedaraMusiView(self._container)

    def _build_marketing_page(self) -> QWidget:
        from xw_office.ui.modules.marketing.view import MarketingView

        return MarketingView(self._container)

    def _build_notation_page(self) -> QWidget:
        from xw_office.ui.modules.notation.view import NotationView

        return NotationView(self._container)

    def _build_xw_copilot_page(self) -> QWidget:
        from xw_office.ui.modules.xw_copilot.view import XWCopilotView
